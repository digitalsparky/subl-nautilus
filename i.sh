...
mv subl-nautilus.py ~/.local/share/nautilus-python/extensions/subl-nautilus.py
#wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/subl-nautilus.py https://raw.githubusercontent.com/DigitalSparky/subl-nautilus/master/subl-nautilus.py
